/* ============================================================
 * Scene Drawing Foundation · Unit 01 · Lesson 02 — Wide Shot
 * NEW BUILD — parallel "Learning Canvas" version, round 1 (local
 * only, not yet reviewed). Lives at lesson-02-wide-full-shot-v2/,
 * alongside the OLD, still-LIVE 13-stage build at
 * lesson-02-wide-full-shot/ (untouched by this build). Do not
 * promote until Faye has reviewed this round.
 *
 ...
 * scene_drawing_unit_01.requiredIds, which already expects this exact
 * string) so this new build's completion counts toward the same
 * badge once promoted, per the standing "never rename identifiers
 * this system keys on" rule. Not currently written anywhere by this
 * parallel build (nothing here is live), but kept correct now so
 * promotion doesn't require an identifier change later.
 * ============================================================ */
(function (global) {
  'use strict';
