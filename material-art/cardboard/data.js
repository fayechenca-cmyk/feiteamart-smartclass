...
const asset = (id, label, kind = 'image') => ({ id, label, kind, src: '', alt: label });
...
const lessons = [
 ...
 section('question','question',"TODAY’S QUESTION",'Can an old cardboard box become a strong creative structure?',{body:'Today, we are not starting with a finished design. We are starting with one material: cardboard.',video:asset('intro-video','Intro video','video')}),
 section('materials','materials','WHAT YOU NEED','Gather your materials. Reused, clean cardboard is our starting point.',{image:asset('materials-flatlay','Materials flat-lay')}),
...
export const course = {id:'remake-01-cardboard',title:'RE:MAKE 01 — CARDBOARD',subtitle:'From Waste Material to Creative Structure',age:'Ages 10–15',type:'Project-Based Smart Class',cover:asset('course-cover','Cardboard final project hero image'),definitions,lessons};
