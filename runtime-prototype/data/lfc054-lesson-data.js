export const lfc054LessonDataDraft = {
  lessonMeta: {
    ...
    xpTotal: 100,
    subtitle: "Start from the real world. Change one rule.",
    description:
      "An artwork-led surrealism lesson that moves from visual understanding to playful image logic to guided colored-pencil making.",
    ...
    screens: [
      {
        ...
        content: {
          hero: {
            ...
            title: "Surreal Worlds",
            subtitle: "Start from the real world. Change one rule.",
            body: "This lesson begins by looking closely, then builds toward your own surreal image with colored pencils.",
  ...
  completionConfig: {
    ...
    journeyMilestoneText: "Completed Surreal Worlds",
